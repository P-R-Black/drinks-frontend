...
export const TestHero = () => {
    ...
    let topImage = 'url(' + require ('../../assets/BarTopImage.png')
    let middleImage = 'url(' + require ('../../assets/BarMiddleImage.png')
    let bottomImage = 'url(' + require ('../../assets/BarBottomImage.png')
