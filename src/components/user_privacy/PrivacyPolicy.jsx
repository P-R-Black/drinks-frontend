  ...
  return (
        <section className="privacyPolicySection">
            <div className="container">
                ...
                <div className="privacyEffectiveDate">April 03, 2024</div>
                <div className="privacyContainer">
                    <div className="privacyParagraphsContainer">
                        <p>
                            Keep's Guide (Keep's Guide) values its users' privacy. This Privacy Policy 
                            ...
                            information we collect. Our Policy has been designed and created to ensure 
                            those affiliated with Keep's Guide of our commitment and realization of our 
                        ...
                        <p>
                            ...
                            you to frequently visit this page. If at any point in time Keep's Guide decides 
                            to make use of any personally identifiable information on file, in a manner 
                            vastly different from that which was stated when this information was 
                            initially collected, the user or users shall be promptly notified by email. 
                            Users at that time shall have the option as to whether to permit the use of 
                            their information in this separate manner.
                        </p>
                        <p>
                            This Policy applies to Keep's Guide, and it governs any and all data 
                            collection and usage by us. Through the use of keepsguide.com, you are 
                        ...
                        <p>
                            ...
                            information by companies that Keep's Guide does not control, nor by 
                        ...
                        <ol className="privacyOrderedList">
                        ...
                        <p>
                            ...
                            <ol className="privacyBulletListInner">
                                <li>
                        ...
                        <p>
                            In addition, Keep's Guide may have the occasion to collect non-personal 
                            ...
                            you are using, IP address, or type of operating system, which will 
                            assist us in providing and maintaining superior quality service.
                        </p>
                        <p>
                            Keep's Guide may also deem it necessary, from time to time, to follow 
                        ...
                        <p>
                            ...
                            <ol className="privacyBulletListInner">
                                ...
                                <li>To fulfill our legitimate interest in improving our services and 
                                    products;</li>
                                <li>To send you promotional emails containing information we think 
                                    you may like when we have your consent to do so;</li>
                                <li>To contact you to fill out surveys or participate in other types 
                                    of market research, when we have your consent to do so;</li>
                                <li>To customize our website according to your online behavior and 
                        ...
                        <p>
                            Keep's Guide may collect and may make use of personal information to 
                            ...
                            use personally identifiable information as a means to keep you informed 
                            of other possible products and/or services that may be available to you 
                            from keepsguide.com
                        </p>
                        <p>
                            Keep's Guide may also be in contact with you with regards to completing 
                        ...
                        <p>
                            Keep's Guide may find it beneficial to all our customers to share 
                        ...
                        <p>
                            Keep's Guide uses various third-party social media features including 
                            but not limited to Facebook, X, Tumblr, TikTock, Instagram and other 
                            interactive programs. These may collect your IP address and require 
                            cookies to work properly. These services are governed by the privacy 
                            policies of the providers and are not within Keep's Guide's control.
                        </p>
                        <h3>Disclosure of Information</h3>
                        <p>
                            Keep's Guide may not use or disclose the information provided by you 
                            except under the following circumstances:
                        </p>
                        <ol className="privacyBulletListInner">
                            <li>as necessary to provide services or products you have ordered;</li>
                            <li>in other ways described in this Policy or to which you have 
                                otherwise consented;</li>
                            <li>in the aggregate with other information in such a way so that 
                                your identity cannot reasonably be determined;</li>
                            <li>as required by law, or in response to a subpoena or search 
                                warrant;</li>
                            <li>to outside auditors who have agreed to keep the information 
                                confidential;</li>
                            <li>as necessary to enforce the Terms of Service;</li>
                            <li>as necessary to maintain, safeguard and preserve all the rights 
                                and property of Keep's Guide.</li>
                        </ol>
                        <h3>Non-Marketing Purposes</h3>
                        <p>
                            Keep's Guide greatly respects your privacy. We do maintain and reserve 
                            the right to contact you if needed for non-marketing purposes (such as 
                            bug alerts, security breaches, account issues, and/or changes in Keep's 
                            Guide products and services). In certain circumstances, we may use our 
                            website, newspapers, or other public means to post a notice.
                        </p>
                        <h3>Children under the age of 13</h3>
                        <p>
                            Keep's Guide's website is not directed to, and does not knowingly collect 
                            ...
                            such information. Anyone under the age of thirteen (13) must seek and 
                        ...
                        <p>
                            ...
                            you wish to unsubscribe to pblackdevdemo@gmail.com. If you wish to 
                            unsubscribe or opt-out from any third-party websites, you must go to 
                            that specific website to unsubscribe or opt-out. Keep's Guide will 
                            continue to adhere to this Policy with respect to any personal 
                            information previously collected.
                        </p>
                        <h3>Links to Other Websites</h3>
                        <p>
                            Our website does contain links to affiliate and other websites. Keep's 
                            Guide does not claim nor accept responsibility for any privacy policies, 
                        ...
                        <p>
                            Keep's Guide's operations are located primarily in the United States. If 
                            you provide information to us, the information will be transferred out
                             of the European Union (EU) and sent to the United States. (The adequacy 
                             decision on the EU-US Privacy became operational on August 1, 2016. 
                             This framework protects the fundamental rights of anyone in the EU whose 
                        ...
                        <h3>Security</h3>
                        <p>
                            Keep's Guide takes precautions to protect your information. When you 
                        ...
                        <p>
                            ...
                            computers and servers in which we store personally identifiable information 
                            are kept in a secure environment. This is all done to prevent any loss, 
                        ...
                        <p>
                            ...
                            <p className="sitePhoneNumber"><span>Telehone Number: </span>(561)729-5153</p>
                            <p className="siteEmail"><span>Email:  </span>pblackdevdemo@gmail.com</p>
                            <p className="siteAddress"><span>Mailing Address: </span>PO Box 220085 Rosedale, NY 11422</p>
                    </div>
                </div>
            </div>
        </section>
